...
date
echo "This job runs step 9 of Rupings VAP pipeline; Runs strelka and samtools scanning."
...
perl /srv/gsfs0/projects/curtis/ruping/tools/seqare/DTrace.pl --configure $CONFIG --chrPrefInBam chr --runlevel 4 --sampleName $SAMPLE --indel strelkaOnly --seqType paired-end,WGS --root $ROOT --threads $THREADS --somaticInfo $SOMATICINFO 2>>$ROOT/logs/$SAMPLE.run.log.strelka
