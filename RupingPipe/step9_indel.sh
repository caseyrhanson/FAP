...
perl /srv/gsfs0/projects/curtis/ruping/tools/seqare/DTrace.pl --configure $CONFIG --runlevel 4 --sampleName $SAMPLE --indel strelkaOnly --seqType paired-end,WXS --root $ROOT --threads $THREADS --somaticInfo $SOMATICINFO 2>>$ROOT/logs/$SAMPLE.run.log.strelka
