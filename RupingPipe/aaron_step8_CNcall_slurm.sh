...
date
echo "This job runs step 8 of Rupings VAP pipeline; Runs CN calling from Titan"
...
perl /srv/gsfs0/projects/curtis/ruping/tools/seqare/DTrace.pl --configure $CONFIG --chrPrefInBam chr --runlevel 5 --sampleName $SAMPLE --seqType paired-end,WGS --root $ROOT --threads $THREADS --somaticInfo $SOMATICINFO --plpeTitan TRUE --ncTitan 0.5 2>>$ROOT/logs/$SAMPLE.run.log.cna
