...
perl /srv/gsfs0/projects/curtis/ruping/tools/seqare/DTrace.pl --configure $CONFIG --runlevel 3 --sampleName $SAMPLE --seqType paired-end,WXS --root $ROOT --threads $THREADS --somaticInfo $SOMATICINFO --maxInsLine 2000000 --lorenzScaleFactor 0.95 2>>$ROOT/logs/$SAMPLE.run.log.wigstats
